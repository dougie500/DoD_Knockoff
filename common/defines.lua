...
country = {
	...
	MOVEMENT_RADICALISM_BASE = 20,
	MOVEMENT_RADICALISM_PASSED_REFORM_EFFECT  = -2,
	MOVEMENT_RADICALISM_NATIONALISM_FACTOR = 0.3,
...
diplomacy = {
	...
	GOODRELATION_PRESTIGE_ADD_TO_SPHERE = -10,
	...
	WARGOAL_JINGOISM_REQUIREMENT = -1,
